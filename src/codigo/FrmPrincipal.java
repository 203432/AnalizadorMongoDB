        ...
        while (true) {
            ...
            switch (token) {
                case Linea:
                    ...
                    break;
                case use:
                    resultado += "  <palabra reservada use>\t" + lexer.lexeme + "\n";
                    break;
                case collection:
                    resultado += "  <palabra reservada collection>" + lexer.lexeme + "\n";
                    break;
                case insertOne:
                    resultado += "  <palabra reservada insertOne>" + lexer.lexeme + "\n";
                    break;
                case find:
                    resultado += "  <palabra reservada find>\t" + lexer.lexeme + "\n";
                    break;
                case updateOne:
                    resultado += "  <palabra reservada updateOne>" + lexer.lexeme + "\n";
                    break;
                case filter:
                    resultado += "  <palabra reservada filter>\t" + lexer.lexeme + "\n";
                    break;
                case update:
                    resultado += "  <palabra reservada update>\t" + lexer.lexeme + "\n";
                    break;
                case deleteOne:
                    resultado += "  <palabra reservada deleteOne>" + lexer.lexeme + "\n";
                    break;
                case close:
                    resultado += "  <palabra reservada close>\t" + lexer.lexeme + "\n";
                    break;
                case ParentesisA:
                ...
                case LlaveC:
                    ...
                    break;
                case PuntoDoble:
                    resultado += "  <PuntoDoble>\t\t" + lexer.lexeme + "\n";
                    break;
                case Coma:
